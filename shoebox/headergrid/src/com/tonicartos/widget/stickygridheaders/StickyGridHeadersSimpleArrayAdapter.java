...
public class StickyGridHeadersSimpleArrayAdapter<T, K extends TextView> extends BaseAdapter implements StickyGridHeadersSimpleAdapter {
    ...
    /**
     * also need to work on the grouping.
     *
    ...
    public long getHeaderId(int position) {
        ...
        CharSequence charFirst = value.subSequence(0, 1);
        return processHeaderId(value.charAt(0), charFirst.charAt(0));
    }

    protected long processHeaderId(char firstChar, long character_index_order) {

        return character_index_order;
    }
    ...
    public View getHeaderView(int position, View convertView, ViewGroup parent) {
        ...
        holder.textView.setText(displayHeaderLetter(string));

        return convertView;
    }

    protected CharSequence displayHeaderLetter(CharSequence inputString) {
        return inputString.subSequence(0, 1);
    }
